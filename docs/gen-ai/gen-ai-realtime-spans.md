...
| `user_speech` | Describes the process of recording user speech input. [37] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[37]:** This operation SHOULD be reported when instrumentation can reliably determine the
