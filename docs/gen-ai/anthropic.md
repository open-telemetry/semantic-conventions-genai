...
| [`gen_ai.usage.input_audio_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [17] | int | The number of audio tokens used in the GenAI input (prompt). [18] | `50` |
...
| [`gen_ai.usage.output_audio_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [20] | int | The number of audio tokens used in the GenAI response (completion). [21] | `30` |
...
**[17] `gen_ai.usage.input_audio_tokens`:** When the model reports audio input tokens separately.

**[18] `gen_ai.usage.input_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.
...
**[20] `gen_ai.usage.output_audio_tokens`:** When the model reports audio output tokens separately.

**[21] `gen_ai.usage.output_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.output_tokens`.
