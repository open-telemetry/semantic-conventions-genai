...
| [`gen_ai.usage.reasoning.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when applicable | int | The number of output tokens used for reasoning (e.g. chain-of-thought, extended thinking). [19] | `50` |
| [`gen_ai.usage.text.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of text-modality input tokens served from a provider-managed cache. [20] | `30` |
| [`gen_ai.usage.text.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as text modality. [21] | `90` |
| [`gen_ai.usage.text.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of output tokens that the provider reported as text modality. [22] | `180` |
| [`gen_ai.usage.video.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of video-modality input tokens served from a provider-managed cache. [23] | `10` |
| [`gen_ai.usage.video.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as video modality. [24] | `20` |
| [`server.address`](https://github.com/open-telemetry/semantic-conventions/blob/v1.41.1/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [25] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
...
**[14] `gen_ai.usage.cache_write.input_tokens`:** Anthropic reports this as `cache_creation_input_tokens`, separately from `input_tokens`. This value MUST be added to the Anthropic `input_tokens` to compute `gen_ai.usage.input_tokens`.
...
**[18] `gen_ai.usage.input_tokens`:** Anthropic `input_tokens` excludes cached tokens. Compute: `gen_ai.usage.input_tokens = input_tokens + cache_read_input_tokens + cache_creation_input_tokens`

**[19] `gen_ai.usage.reasoning.output_tokens`:** The value SHOULD be included in `gen_ai.usage.output_tokens`.

**[20] `gen_ai.usage.text.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.text.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality cached input token count.

**[21] `gen_ai.usage.text.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality input token count.

**[22] `gen_ai.usage.text.output_tokens`:** The value is a subset of `gen_ai.usage.output_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality output token count.

**[23] `gen_ai.usage.video.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.video.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the video-modality cached input token count.

**[24] `gen_ai.usage.video.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the video-modality input token count.
...
**[26] `gen_ai.input.messages`:** Instrumentations MUST follow [Input messages JSON schema](/docs/gen-ai/gen-ai-input-messages.json).
...
**[27] `gen_ai.output.messages`:** Instrumentations MUST follow [Output messages JSON schema](/docs/gen-ai/gen-ai-output-messages.json)
