...
| [`gen_ai.input.messages_ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The reference to the input messages in external storage. [35] | `s3://example-bucket/gen-ai/trace-123/input-messages.json` |
...
| [`gen_ai.output.messages_ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The reference to the output messages in external storage. [37] | `s3://example-bucket/gen-ai/trace-123/output-messages.json` |
...
| [`gen_ai.system_instructions_ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The reference to the system instructions in external storage. [40] | `s3://example-bucket/gen-ai/trace-123/system-instructions.json` |
...
**[35] `gen_ai.input.messages_ref`:** This attribute identifies the external storage target for the value that
...
**[37] `gen_ai.output.messages_ref`:** This attribute identifies the external storage target for the value that
...
**[40] `gen_ai.system_instructions_ref`:** This attribute identifies the external storage target for the value that
