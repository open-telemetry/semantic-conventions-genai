...
**[13] `gen_ai.usage.cache_write.input_tokens`:** Anthropic reports this as `cache_creation_input_tokens`, separately from `input_tokens`. This value MUST be added to the Anthropic `input_tokens` to compute `gen_ai.usage.input_tokens`.
