...
**[39] `gen_ai.tool.definitions`:** The effective set of tools provided to this model request, recorded after
...
**[13] `gen_ai.tool.definitions`:** The set of tools carried on the fetched response.
