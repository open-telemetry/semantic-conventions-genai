...
| [`gen_ai.usage.input_audio_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [19] | int | The number of audio tokens used in the GenAI input (prompt). [20] | `50` |
...
| [`gen_ai.usage.output_audio_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [22] | int | The number of audio tokens used in the GenAI response (completion). [23] | `30` |
...
**[19] `gen_ai.usage.input_audio_tokens`:** When the model reports audio input tokens separately.

**[20] `gen_ai.usage.input_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.
...
**[22] `gen_ai.usage.output_audio_tokens`:** When the model reports audio output tokens separately.

**[23] `gen_ai.usage.output_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.output_tokens`.
