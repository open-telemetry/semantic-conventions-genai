...
| [`gen_ai.input.messages_ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | A URI identifying the input messages in external storage. [37] | `s3://example-bucket/gen-ai/674f35f4-e3f6-41f5-b104-864b3964f6d3_inputs.json` |
...
| [`gen_ai.output.messages_ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | A URI identifying the output messages in external storage. [39] | `s3://example-bucket/gen-ai/674f35f4-e3f6-41f5-b104-864b3964f6d3_outputs.json` |
...
**[37] `gen_ai.input.messages_ref`:** This attribute identifies an external representation of the complete
...
**[39] `gen_ai.output.messages_ref`:** This attribute identifies an external representation of the complete
...
**[42] `gen_ai.system_instructions_ref`:** This attribute identifies an external representation of the complete
...
**[44] `gen_ai.tool.definitions_ref`:** This attribute identifies an external representation of the complete
