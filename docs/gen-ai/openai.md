...
**[39] `gen_ai.tool.definitions`:** The effective set of tools provided to this model request, recorded after any runtime filtering, resolution, or name-collision handling has been applied.
...
**[14] `gen_ai.tool.definitions`:** The set of tools carried on the fetched response.
