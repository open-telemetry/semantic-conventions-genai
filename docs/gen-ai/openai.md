...
| `user_speech` | Describes the process of recording user speech input. [43] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `update_memory` | Update existing memory records | ![Development](https://img.shields.io/badge/-development-blue) |
| `upsert_memory` | Create or update memory records without the caller choosing which | ![Development](https://img.shields.io/badge/-development-blue) |
| `user_speech` | Describes the process of recording user speech input. [17] | ![Development](https://img.shields.io/badge/-development-blue) |
