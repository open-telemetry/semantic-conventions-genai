...
| [`openai.api.type`](/docs/registry/attributes/openai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The type of OpenAI API being used. [9] | `chat_completions`; `responses` |
...
**[9] `openai.api.type`:** For this operation `openai.api.type` SHOULD be set to `responses`.
