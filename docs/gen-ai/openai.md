...
| [`gen_ai.usage.audio.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of audio-modality input tokens served from a provider-managed cache. [12] | `20` |
| [`gen_ai.usage.audio.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as audio modality. [13] | `10` |
| [`gen_ai.usage.audio.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of output tokens that the provider reported as audio modality. [14] | `10` |
...
| [`gen_ai.usage.cache_write.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens written to a provider-managed cache this turn. [16] | `25` |
| [`gen_ai.usage.image.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of image-modality input tokens served from a provider-managed cache. [17] | `10` |
| [`gen_ai.usage.image.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as image modality. [18] | `40` |
| [`gen_ai.usage.image.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of output tokens that the provider reported as image modality. [19] | `1056` |
...
| [`gen_ai.usage.text.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of text-modality input tokens served from a provider-managed cache. [22] | `30` |
| [`gen_ai.usage.text.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as text modality. [23] | `90` |
| [`gen_ai.usage.text.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of output tokens that the provider reported as text modality. [24] | `180` |
| [`gen_ai.usage.video.cache_read.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of video-modality input tokens served from a provider-managed cache. [25] | `10` |
| [`gen_ai.usage.video.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` when the provider reports it | int | The number of input tokens that the provider reported as video modality. [26] | `20` |
...
| [`server.address`](https://github.com/open-telemetry/semantic-conventions/blob/v1.41.1/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [27] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
...
**[12] `gen_ai.usage.audio.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.audio.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the audio-modality cached input token count.

**[13] `gen_ai.usage.audio.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the audio-modality input token count.

**[14] `gen_ai.usage.audio.output_tokens`:** The value is a subset of `gen_ai.usage.output_tokens`. Instrumentations MUST only set this attribute when the provider reports the audio-modality output token count.
...
**[16] `gen_ai.usage.cache_write.input_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.

**[17] `gen_ai.usage.image.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.image.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the image-modality cached input token count.

**[18] `gen_ai.usage.image.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the image-modality input token count.

**[19] `gen_ai.usage.image.output_tokens`:** The value is a subset of `gen_ai.usage.output_tokens`. Instrumentations MUST only set this attribute when the provider reports the image-modality output token count.

**[20] `gen_ai.usage.input_tokens`:** The total input token count is returned by `usage.input_tokens` or a similar property in the model response.
...
**[22] `gen_ai.usage.text.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.text.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality cached input token count.

**[23] `gen_ai.usage.text.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality input token count.

**[24] `gen_ai.usage.text.output_tokens`:** The value is a subset of `gen_ai.usage.output_tokens`. Instrumentations MUST only set this attribute when the provider reports the text-modality output token count.

**[25] `gen_ai.usage.video.cache_read.input_tokens`:** The value is a subset of both `gen_ai.usage.video.input_tokens` and `gen_ai.usage.cache_read.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the video-modality cached input token count.

**[26] `gen_ai.usage.video.input_tokens`:** The value is a subset of `gen_ai.usage.input_tokens`. Instrumentations MUST only set this attribute when the provider reports the video-modality input token count.
...
**[28] `gen_ai.input.messages`:** Instrumentations MUST follow [Input messages JSON schema](/docs/gen-ai/gen-ai-input-messages.json).
...
**[29] `gen_ai.output.messages`:** Instrumentations MUST follow [Output messages JSON schema](/docs/gen-ai/gen-ai-output-messages.json)
...
**[31] `gen_ai.tool.definitions`:** Instrumentations MUST follow [Tool Definitions JSON Schema](/docs/gen-ai/gen-ai-tool-definitions.json).
...
### Metric: `gen_ai.client.inference.tokens`

Reports the number of tokens used in inference following the common [gen_ai.client.inference.tokens](./gen-ai-metrics.md#metric-gen_aiclientinferencetokens) definition.

<!-- weaver .refinements.metrics[] | select(.id == "openai.client.inference.tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.tokens` | Counter | `{token}` | OpenAI-specific extension to `gen_ai.client.inference.tokens`. Adds `openai.response.service_tier` and `openai.response.system_fingerprint` when the provider is `openai`. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |

**[1]:** Instrumentations that don't know the token modality MUST set
`gen_ai.token.modality=unknown`. Instrumentations with partial
modality information MUST report the known portions under their
actual modality and the remainder under `unknown`.
...
| [`gen_ai.token.modality`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The modality of the tokens being counted. [3] | `text`; `audio`; `unknown` |
...
**[3] `gen_ai.token.modality`:** Use `unknown` when the provider does not report a modality breakdown.
...
| `document` | Document tokens. | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `unknown` | Tokens of unknown or unreported modality. | ![Development](https://img.shields.io/badge/-development-blue) |
| `video` | Video tokens. | ![Development](https://img.shields.io/badge/-development-blue) |
