...
- [Event: `gen_ai.context.selection.evaluated`](#event-gen_aicontextselectionevaluated)
...
<!-- weaver .registry.events[] | select(.name == "gen_ai.context.selection.evaluated") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
The event name MUST be `gen_ai.context.selection.evaluated`.

Captures privacy-preserving counts for context inputs considered, selected, suppressed, and delivered to a GenAI agent or model.

This event is intended to answer whether an agent run loaded too much context before any later evaluator can determine which context was decision-relevant. It SHOULD NOT record raw prompts, raw context text, tool outputs, memory bodies, or repository excerpts.

**Attributes:**

| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`gen_ai.context.selection.candidate.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | int | The number of context inputs considered for possible delivery to a GenAI agent or model. [1] | `18` |
...
**[2] `gen_ai.context.selection.selected.count`:** This count SHOULD represent inputs selected after discovery and filtering, before or at delivery. It does not imply that the selected inputs were decision-relevant.
