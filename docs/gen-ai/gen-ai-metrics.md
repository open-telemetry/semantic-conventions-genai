...
very different unit magnitude SHOULD adjust them.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.operation.cost") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
**[3] `gen_ai.usage.cost.currency`:** MUST be a three-letter ISO 4217 alphabetic code (e.g. "USD", "EUR").
...
| Value | Description | Stability |
| --- | --- | --- |
| `local` | The emitting component computed the value itself. [12] | ![Development](https://img.shields.io/badge/-development-blue) |
| `provider` | The cost value was present in the response the client received. [13] | ![Development](https://img.shields.io/badge/-development-blue) |

**[12]:** No cost was present in the response; the emitting component
...
**[13]:** The cost value was present in the response the instrumented
