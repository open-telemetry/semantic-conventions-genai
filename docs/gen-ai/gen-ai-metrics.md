...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.token.usage` | Counter | `{token}` | Number of input and output tokens used. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| gen_ai.token.cache=uncached   | gen_ai.usage.input_tokens - gen_ai.usage.cache_read.input_tokens - gen_ai.usage.cache_creation.input_tokens |
