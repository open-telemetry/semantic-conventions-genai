...
- [Semantic conventions for generative AI metrics](#semantic-conventions-for-generative-ai-metrics)
  - [Generative AI client metrics](#generative-ai-client-metrics)
    ...
    - [Metric: `gen_ai.client.inference.input_tokens_by_cache`](#metric-gen_aiclientinferenceinput_tokens_by_cache)
    - [Metric: `gen_ai.client.inference.output_tokens_by_phase`](#metric-gen_aiclientinferenceoutput_tokens_by_phase)
    - [Metric: `gen_ai.client.inference.operation.tokens`](#metric-gen_aiclientinferenceoperationtokens)
    ...
    - [Metric: `gen_ai.client.embeddings.tokens`](#metric-gen_aiclientembeddingstokens)
...
When systems report both used tokens and billable tokens, instrumentations MUST report billable tokens.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.tokens") -->
...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.tokens` | Counter | `{token}` | Number of input and output tokens used in client inference operations. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
### Metric: `gen_ai.client.inference.input_tokens_by_cache`

This metric is [recommended][MetricRecommended] when the provider reports token
usage for the inference call.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.input_tokens_by_cache") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.input_tokens_by_cache` | Counter | `{token}` | Number of input tokens used in client inference operations, partitioned by cache status and modality. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |

**[1]:** Per inference call, the total tokens reported on this counter MUST
equal the total reported on `gen_ai.client.inference.tokens` with
`gen_ai.token.type=input`.

When the provider reports no cache fields, instrumentations MUST
report the full input total under `gen_ai.token.cache=uncached`.

When the provider does not report token modality broken down by
cache state, instrumentations MUST set
`gen_ai.token.modality=unknown` on the cache cells.
...
| [`gen_ai.token.modality`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The modality of the tokens being counted. [4] | `text`; `audio`; `unknown` |
...
**[3] `gen_ai.token.cache`:** Applies only to input tokens.

**[4] `gen_ai.token.modality`:** Use `unknown` when the provider does not report a modality breakdown.
...
### Metric: `gen_ai.client.inference.output_tokens_by_phase`

This metric is [recommended][MetricRecommended] when the provider reports token
usage for the inference call.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.output_tokens_by_phase") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.output_tokens_by_phase` | Counter | `{token}` | Number of output tokens used in client inference operations, partitioned by generation phase. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| [`gen_ai.operation.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The name of the operation being performed. [1] | `chat`; `generate_content`; `text_completion` |
| [`gen_ai.provider.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The Generative AI provider as identified by the client or server instrumentation. [2] | `openai`; `gcp.gen_ai`; `gcp.vertex_ai` |
| [`gen_ai.token.phase`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The generation phase of the output tokens being counted. [3] | `response`; `reasoning` |
| [`gen_ai.request.model`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If available. | string | The name of the GenAI model a request is being made to. [4] | `gpt-4` |
| [`server.port`](https://github.com/open-telemetry/semantic-conventions/blob/v1.41.1/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If `server.address` is set. | int | GenAI server port. [5] | `80`; `8080`; `443` |
| [`gen_ai.response.model`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the model that generated the response. | `gpt-4-0613` |
| [`server.address`](https://github.com/open-telemetry/semantic-conventions/blob/v1.41.1/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [6] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
...
**[3] `gen_ai.token.phase`:** Applies only to output tokens.
...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.operation.tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.operation.tokens` | Histogram | `{token}` | Per-operation distribution of total tokens (input + output) used by a single client inference call. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.operation.input_tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.operation.input_tokens` | Histogram | `{token}` | Per-operation distribution of input tokens used by a single client inference call. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.operation.output_tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.operation.output_tokens` | Histogram | `{token}` | Per-operation distribution of output tokens used by a single client inference call. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
### Metric: `gen_ai.client.embeddings.tokens`

This metric is [recommended][MetricRecommended] when the provider reports token
usage for the embeddings call.

When systems report both used tokens and billable tokens, instrumentations MUST report billable tokens.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.embeddings.tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.embeddings.tokens` | Counter | `{token}` | Number of input tokens used in client embeddings operations. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |

**[1]:** Embeddings operations consume input tokens only and produce no output
tokens, so this counter records input tokens exclusively.
...
[MetricOptIn]: https://github.com/open-telemetry/semantic-conventions/blob/v1.40.0/docs/general/metric-requirement-level.md#opt-in
