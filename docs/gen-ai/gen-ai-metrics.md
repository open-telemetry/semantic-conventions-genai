...
- [Generative AI skill metrics](#generative-ai-skild-metrics)
...
### Metric: `gen_ai.invoke_agent.skill_loads`

See [agent-skills](/docs/gen-ai/gen-ai-agent-spans.md#agent-skills) for skill definition.

<!-- weaver .registry.metrics[] | select(.name == "gen_ai.invoke_agent.skill_loads") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.invoke_agent.skill_loads` | Histogram | `{tool_call}` | The number of tool calls resulting in loading a skill a GenAI agent makes during a single invocation. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
See [agent-skills](/docs/gen-ai/gen-ai-agent-spans.md#agent-skills) for skill definition.
When a metric is used to represent skill related tool execution, instrumentations SHOULD
refine `gen_ai.execute_tool.duration` as described below.
...
### Metric: `gen_ai.execute_tool.skill_load`

<!-- weaver .refinements.metrics[] | select(.id == "gen_ai.execute_tool.skill_load") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.execute_tool.duration` | Histogram | `s` | Extension for `gen_ai.execute_tool.duration` for tool resulting into loading a skill into GenAI agent's context. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
**[2] `gen_ai.skill.name`:** If skill loaded succesfully and its name is available.
...
## Metric: `gen_ai.execute_tool.command`

<!-- weaver .refinements.metrics[] | select(.id == "gen_ai.execute_tool.command") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.execute_tool.duration` | Histogram | `s` | Extension for `gen_ai.execute_tool.duration` for tool executing custom scripts, commands, or executable files. Adds information about executable and execution. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| [`gen_ai.agent.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` When applicable. | string | The human-readable name of the agent executing the tool. | `Math Tutor`; `Fiction Writer` |
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [2] | string | The name of the [Agent Skill](https://agentskills.io/specification#skill-md-format). | `code-review`; `pdf-processing` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [3] | string | The skill-relative name of the resource (script, reference, or asset) being accessed or executed. | `references/review_policy.md`; `assets/report_template.html` |
| [`process.executable.name`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/process.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Conditionally Required` [4] | string | The name of the process executable. On Linux based systems, this SHOULD be set to the base name of the target of `/proc/[pid]/exe`. On Windows, this SHOULD be set to the base name of `GetProcessImageFileNameW`. | `otelcol` |
| [`process.exit.code`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/process.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Conditionally Required` [5] | int | The exit code of the process. | `127` |
...
**[2] `gen_ai.skill.name`:** If command is associated with a skill and name is available.

**[3] `gen_ai.skill.resource.name`:** If command is associated with a skill resource and name is available.

**[4] `process.executable.name`:** If tool directly executes a single process and the executable path is available.

**[5] `process.exit.code`:** If tool reports a single command or process exit code.
