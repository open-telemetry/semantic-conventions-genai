...
| <a id="gen-ai-usage-tool-input-tokens" href="#gen-ai-usage-tool-input-tokens">`gen_ai.usage.tool.input_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of input tokens used for tool definitions and tool call results. [45] | `30` |
...
**[31] `gen_ai.usage.audio.cache_read.input_tokens`:** The value SHOULD be included in `gen_ai.usage.cache_read.input_tokens`.
...
**[36] `gen_ai.usage.image.cache_read.input_tokens`:** The value SHOULD be included in `gen_ai.usage.cache_read.input_tokens`.
...
**[42] `gen_ai.usage.text.cache_read.input_tokens`:** The value SHOULD be included in `gen_ai.usage.cache_read.input_tokens`.
...
**[45] `gen_ai.usage.tool.input_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.
