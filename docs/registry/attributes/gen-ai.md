...
| <a id="gen-ai-caller-name" href="#gen-ai-caller-name">`gen_ai.caller.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The human-readable name of the immediate logical caller that initiated the operation. | `planner_agent`; `weather_workflow` |
| <a id="gen-ai-caller-type" href="#gen-ai-caller-type">`gen_ai.caller.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the immediate logical caller that initiated the operation. [2] | `agent`; `workflow` |
...
| <a id="gen-ai-transfer-mode" href="#gen-ai-transfer-mode">`gen_ai.transfer.mode`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Describes how control passes to the transfer target. [34] | `return_to_caller`; `pass_control` |
...
**[2] `gen_ai.caller.type`:** Instrumentations MUST NOT infer caller identity from span hierarchy,
...
**[34] `gen_ai.transfer.mode`:** Instrumentations MUST NOT infer any `gen_ai.transfer.*` attribute from span
