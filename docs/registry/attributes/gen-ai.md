...
| <a id="gen-ai-agent-invocation-id" href="#gen-ai-agent-invocation-id">`gen_ai.agent.invocation.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The unique identifier of the remote agent invocation. [1] | `run_abc123`; `12345678-1234-1234-1234-123456789012` |
