...
| <a id="gen-ai-evaluation-evaluator-id" href="#gen-ai-evaluation-evaluator-id">`gen_ai.evaluation.evaluator.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Stable identifier for the evaluator definition, not the invocation. Results with different evaluator ids must not be treated as comparable. | `judge-v1`; `accuracy-model-abc` |
| <a id="gen-ai-evaluation-evaluator-type" href="#gen-ai-evaluation-evaluator-type">`gen_ai.evaluation.evaluator.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of evaluator. | `llm_judge`; `deterministic`; `human` |
| <a id="gen-ai-evaluation-evaluator-version" href="#gen-ai-evaluation-evaluator-version">`gen_ai.evaluation.evaluator.version`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Version of the evaluator definition. | `1.0`; `v2.5.1` |
...
| <a id="gen-ai-evaluation-reference-set-id" href="#gen-ai-evaluation-reference-set-id">`gen_ai.evaluation.reference_set.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Identifier of the golden/reference set against which the score was produced. [4] | `dataset-123`; `golden-set-v1` |
| <a id="gen-ai-evaluation-scope" href="#gen-ai-evaluation-scope">`gen_ai.evaluation.scope`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The unit the result is about. | `single_output`; `full_run`; `human_interaction` |
...
**[4] `gen_ai.evaluation.reference_set.id`:** Conditionally required when a reference set was used.
...
`gen_ai.evaluation.evaluator.type` has the following list of well-known values. If one of them applies, then the respective value MUST be used; otherwise, a custom value MAY be used.
