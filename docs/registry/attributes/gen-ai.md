...
| <a id="gen-ai-agent-invocation-status" href="#gen-ai-agent-invocation-status">`gen_ai.agent.invocation.status`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The terminal status of an agent invocation. [2] | `completed` |
...
**[2] `gen_ai.agent.invocation.status`:** This attribute records the terminal outcome of an agent invocation. It MUST
