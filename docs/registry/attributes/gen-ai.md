...
| <a id="gen-ai-main-agent-name" href="#gen-ai-main-agent-name">`gen_ai.main_agent.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the main GenAI agent or workflow this operation runs within. [6] | `content_pipeline`; `Travel Planner` |
...
**[6] `gen_ai.main_agent.name`:** Here, "main agent" is a general term for a local root GenAI agent or an agentic workflow.
