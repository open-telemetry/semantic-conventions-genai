...
| <a id="gen-ai-step-name" href="#gen-ai-step-name">`gen_ai.step.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Human-readable name of a step within a GenAI workflow. [25] | `validate_input`; `route_query`; `format_output` |
...
**[25] `gen_ai.step.name`:** A step is a unit of a GenAI workflow that hands control to application- or
...
This attribute along with the corresponding `run_step` operation SHOULD NOT
