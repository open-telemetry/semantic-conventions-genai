...
| <a id="gen-ai-speech-input-language" href="#gen-ai-speech-input-language">`gen_ai.speech.input.language`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The primary language of the input audio for a speech-to-text operation. [22] | `en`; `en-US` |
| <a id="gen-ai-speech-voice" href="#gen-ai-speech-voice">`gen_ai.speech.voice`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name or identifier of the voice used to synthesize speech. [23] | `alloy`; `verse` |
...
| <a id="gen-ai-usage-input-audio-tokens" href="#gen-ai-usage-input-audio-tokens">`gen_ai.usage.input_audio_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of audio tokens used in the GenAI input (prompt). [31] | `50` |
...
| <a id="gen-ai-usage-output-audio-tokens" href="#gen-ai-usage-output-audio-tokens">`gen_ai.usage.output_audio_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of audio tokens used in the GenAI response (completion). [33] | `30` |
...
**[22] `gen_ai.speech.input.language`:** The language of the input audio, as declared in the request or detected during transcription. When available, the value SHOULD be a BCP-47 language tag (for example `en` or `en-US`); some providers report a language name instead, in which case the reported value is used as-is.

**[23] `gen_ai.speech.voice`:** Applies to text-to-speech (speech synthesis) operations. The value is the provider-specific voice name or identifier requested by the client, for example the OpenAI `voice` parameter (`alloy`, `verse`).
...
**[31] `gen_ai.usage.input_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.
...
**[33] `gen_ai.usage.output_audio_tokens`:** The value SHOULD be included in `gen_ai.usage.output_tokens`.
