...
| <a id="gen-ai-skills" href="#gen-ai-skills">`gen_ai.skills`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | The skills whose instructions are in the operation's context, and whether each one is held in compacted form. [32] | `[{"name": "code-review", "compacted": true}, {"name": "pdf-processing", "compacted": false}]` |
...
**[32] `gen_ai.skills`:** One entry per skill the agent has loaded, whether during this operation or
