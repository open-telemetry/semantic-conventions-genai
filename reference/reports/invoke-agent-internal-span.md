...
| --- | --- |
| gen_ai.operation.name | [agent-framework], [autogen], [crewai], [google-adk], [openai-agents], [openai-cascade], [openai-realtime], [pydantic-ai] |
...
| gen_ai.request.model | [agent-framework], [autogen], [crewai], [google-adk], [openai-agents], [openai-realtime], [pydantic-ai] |
