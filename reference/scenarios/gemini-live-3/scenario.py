...
Exercises the *child* tool-call pattern within one realtime session against the mock
...
client-created per-connection id and use it as ``gen_ai.realtime_session.id``.
