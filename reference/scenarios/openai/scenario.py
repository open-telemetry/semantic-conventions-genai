...
def run_security_guardrail_reference():
    ...
    with _reference_tracer.start_as_current_span("chat gpt-4o-mini", attributes=parent_attrs) as parent_span:
        ...
        guardrail_attrs = {
            ...
            "gen_ai.guardrail.security.policy.name": "PII Protection Policy",
            "gen_ai.guardrail.security.policy.rule.id": "rule-email",
            "gen_ai.guardrail.security.policy.version": "2.0",
...
def run_remote_security_guardrail_reference():
    ...
    guardrail_attrs = {
        ...
        "gen_ai.guardrail.security.policy.name": "Default Safety Policy",
        "gen_ai.guardrail.security.policy.version": "1.0",
