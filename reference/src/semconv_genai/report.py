...
SEMCONV_DOC_LINKS: dict[str, str] = {
    ...
    "create_memory_store": "../../docs/gen-ai/gen-ai-spans.md#create-memory-store",
    "search_memory": "../../docs/gen-ai/gen-ai-spans.md#search-memory",
    "create_memory": "../../docs/gen-ai/gen-ai-spans.md#create-memory",
    "update_memory": "../../docs/gen-ai/gen-ai-spans.md#update-memory",
    "upsert_memory": "../../docs/gen-ai/gen-ai-spans.md#upsert-memory",
    "delete_memory": "../../docs/gen-ai/gen-ai-spans.md#delete-memory",
    "delete_memory_store": "../../docs/gen-ai/gen-ai-spans.md#delete-memory-store",
