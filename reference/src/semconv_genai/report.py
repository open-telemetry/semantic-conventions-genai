...
SEMCONV_DOC_LINKS: dict[str, str] = {
    ...
    "gen_ai.client.inference.usage.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusageinput_tokens",
    "gen_ai.client.inference.usage.output_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusageoutput_tokens",
    "gen_ai.client.inference.usage.detailed.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagedetailedinput_tokens",
    "gen_ai.client.inference.usage.detailed.output_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagedetailedoutput_tokens",
    "gen_ai.client.inference.usage.detailed.cache_read.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagedetailedcache_readinput_tokens",
    "gen_ai.client.inference.usage.detailed.cache_write.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagedetailedcache_writeinput_tokens",
    "gen_ai.client.inference.usage.detailed.reasoning.output_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagedetailedreasoningoutput_tokens",
