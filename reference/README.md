...
| [Invoke Agent Internal](reports/invoke-agent-internal-span.md) | agent-framework, autogen, crewai, google-adk, openai-agents, openai-cascade, openai-realtime, pydantic-ai |
| [Invoke Workflow](reports/invoke-workflow-span.md) | crewai, google-adk |
| [Plan](reports/plan-span.md) | crewai, langchain |
| [Inference](reports/inference-span.md) | agent-framework, anthropic, autogen, aws-bedrock, azure-ai-inference, azure-openai, claude-agent-sdk, cohere, crewai, dspy, google-adk, google-genai, groq, instructor, langchain, litellm, llamaindex, mistralai, openai, openai-agents, openai-audio, openai-cascade, openai-realtime, pydantic-ai, vertexai |
...
| [Speech-to-Text](reports/speech-to-text-span.md) | openai-cascade |
| [Text-to-Speech](reports/text-to-speech-span.md) | openai-cascade |
